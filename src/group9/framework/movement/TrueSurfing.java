...
public class TrueSurfing implements IMoveable{
        ...
        public void onScannedRobot(ScannedRobotEvent e){
            ...
            _enemyLocation = CalcUtils.project(_myLocation, absBearing, e.getDistance());
        ...
        public static int getFactorIndex(EnemyWave ew, Point2D.Double targetLocation) {
            double offsetAngle = (CalcUtils.absoluteBearing(ew.fireLocation, targetLocation)
                    - ew.directAngle);
        ...
        public Point2D.Double predictPosition(EnemyWave surfWave, int direction) {
            ...
            do {
                moveAngle =
                        WallSmoothing.wallSmoothing(predictedPosition, CalcUtils.absoluteBearing(surfWave.fireLocation,
                ...
                predictedPosition = CalcUtils.project(predictedPosition, predictedHeading, predictedVelocity);
        ...
        public void doSurfing() {
            ...
            double goAngle = CalcUtils.absoluteBearing(surfWave.fireLocation, _myLocation);
            if (dangerLeft < dangerRight) {
                goAngle = WallSmoothing.wallSmoothing(_myLocation, goAngle - (Math.PI/2), -1);
            } else {
                goAngle = WallSmoothing.wallSmoothing(_myLocation, goAngle + (Math.PI/2), 1);
            }
